...
public class TLogo {
	...
	public TLogo(Image img, int sizeX, int sizeY, Pane root) {
		logo.setImage(img);
	...
	public TLogo(Image img, int sizeX, int sizeY, int posX, int posY, Pane root) {
		logo.setImage(img);
		logo.setFitWidth(sizeX);
		logo.setFitHeight(sizeY);
		logo.setOpacity(opacity);
	...
	public TLogo(Image img, int sizeX, int sizeY, double opacit, Pane root) {
		logo.setImage(img);
		logo.setFitWidth(sizeX);
		logo.setFitHeight(sizeY);
